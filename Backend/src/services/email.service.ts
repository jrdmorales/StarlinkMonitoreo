...
const FRASES = [
  ...
  "El satélite gira, la obra avanza, nosotros vigilamos 🌍",
  "Firmamos con datos, no con excusas 🖊️",
  "Consumo bajo control… por ahora 😌",
  "Si la antena parpadea, nosotros ya lo sabemos antes que el guardia 💡",
  "Menos drama que grupo familiar en Navidad 🎅",
  "Datos van, datos vienen, el reporte siempre llega 📬",
  "Nuestra fe está en el uptime, no en el horóscopo 🔮",
  "Cada byte cuenta, cada antena importa 🧮",
  "El link satelital no falla solo, tiene ayuda de arriba ☁️",
  "Aquí el único lag permitido es el del café enfriándose ☕",
  "100% de cobertura, 0% de excusas 🙅",
  "Si el consumo sube, la alerta baja rapidito 📉",
  "Monitoreamos como si el WiFi fuera oxígeno 🫁",
  "La obra no para, nosotros tampoco 🏗️",
  "Cielo despejado, señal despejada 🌤️",
  "Nada se cae sin que quede en el log primero 🧾",
  "El bucket del mes se llena, pero nuestra paciencia también aguanta 🪣",
  "Antenas mirando las estrellas, nosotros mirando el dashboard 🌠",
  "Un GB menos es un problema menos 📊",
  "Reportar consumo: nuestro deporte extremo favorito 🏃",
  "El umbral del 80% nos pone nerviosos, pero profesionales 😬",
  "Si algo se corta, aquí ya hay tres alertas mandadas ✉️",
  "Starlink en el cielo, control en la Tierra 🌐",
  "Menos caídas que la bolsa en año electoral 📉😂",
  "Cuidamos los megas como el jefe cuida el presupuesto 💰",
  "La conexión no se negocia, se monitorea 🔒",
  "Aquí el único downtime aceptado es el del almuerzo 🍽️",
  "Cada antena tiene su historia, nosotros la escribimos en logs 📖",
  "Cronjobs corriendo, cafés enfriándose, todo normal ⏱️",
  "Si el gráfico sube, algo se está descargando. Si baja, alguien se durmió 😴",
  "Vigilancia satelital con toque humano 🤖❤️",
  "El proveedor no responde, pero nuestro dashboard sí 📟",
  "Menos suspenso que final de temporada, más alertas que esa misma serie 🍿",
  "Un ping verde vale más que mil promesas de gerencia 🟢",
  "El bag extra de datos: la salvación de fin de mes 🛍️",
  "Aquí revisamos el consumo más seguido que el celular en reunión 📱",
  "Redes conectadas, obras funcionando, jefes tranquilos 🧘",
  "Ninguna antena queda sin su reporte semanal 🗓️",
  "Somos los primeros en enterarnos y los últimos en avisar mal 📢",
  "El clima no afecta la señal, pero afecta nuestro ánimo 🌧️",
  "Cada obra con su antena, cada antena con su vigilante 👀",
  "Datos, gráficos y un poco de humor: nuestra receta diaria 🍳",
  "El uptime es sagrado, el resto se negocia ⛪",
  "Si preguntas '¿hay internet?' ya sabemos la respuesta antes que tú 🔮",
  "Consumo alto detectado… procediendo con pánico controlado 🚨",
  "Nada como un dashboard verde para empezar bien el día 🟢☀️",
  "El satélite no cobra horas extra, nosotros tampoco (por ahora) 😅",
  "Cada alerta enviada es una obra que no se queda sin datos 📡",
  "Aquí el que no reporta, no existe 🧑‍💻",
  "Bolsas de datos: el salvavidas de fin de ciclo 🛟",
  "Monitoreo constante, quejas ocasionales, resultados garantizados ✅",
  "El link no se cae solo, lo cuidamos como huerto propio 🌾",
  "Antena en obra, ojo en el dashboard, mente en el café ☕🛰️",
  "Si ves este correo, es porque alguien ya trabajó por ti 💌",
  "La red no duerme, y nosotros tampoco los martes de sync 🌙",
  "Un consumo estable es la mejor noticia del día 📈➡️➖",
  "Aquí los números no mienten, pero el clima satelital sí puede fallar ⛈️",
  "Starlink Control: porque el internet en obra también merece cariño 💚",
  "El reporte llegó, la calma también 🕊️",
  "Cada bolsa de datos comprada es una obra que respira tranquila 🌬️",
  "Última línea del día: todo en orden, nos vemos mañana 👋",
];
